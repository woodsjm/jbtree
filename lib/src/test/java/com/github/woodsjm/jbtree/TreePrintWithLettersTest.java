...
public class TreePrintWithLettersTest {
  ...
  void testTreePrettyPrintWithLettersWithIndex(
      List<String> letters, List<String> expectedConsoleOutput) {
  ...
  static Stream<Arguments> letterListWithIndexAndExpectedConsoleOutputProvider() {
    return Stream.of(
        ...
        Arguments.arguments(
            Arrays.asList("A", null, "C"), Arrays.asList("0:A_", "    \\", "    2:C")),
        Arguments.arguments(
            Arrays.asList("A", "B", "C"), Arrays.asList("   _0:A_", "  /     \\", "1:B     2:C")),
        Arguments.arguments(
            Arrays.asList("A", "B", "C", null, "E"),
            Arrays.asList(
                "   _____0:A_", "  /         \\", "1:B_        2:C", "    \\", "    4:E")),
        Arguments.arguments(
            Arrays.asList("A", "B", "C", null, "E", "F"),
            Arrays.asList(
                "   _____0:A_____",
                "  /             \\",
                "1:B_           _2:C",
                ...
                "    4:E     5:F")),
        Arguments.arguments(
            Arrays.asList("A", "B", "C", null, "E", "F", "G"),
            Arrays.asList(
                "   _____0:A_____",
                "  /             \\",
                "1:B_           _2:C_",
  ...
  void testTreePrettyPrintWithLettersNoIndex(
      List<String> letters, List<String> expectedConsoleOutput) {
    ConsoleCaptor consoleCaptor =
        ConsoleCaptor.builder().allowTrimmingWhiteSpace(false).allowEmptyLines(true).build();
  ...
  @ParameterizedTest
  @MethodSource("letterListAndExpectedConsoleOutputProvider")
  void testTreeDefaultPrintWithLettersNoIndex(
      List<String> letters, List<String> expectedConsoleOutput) {
    ConsoleCaptor consoleCaptor =
        ConsoleCaptor.builder().allowTrimmingWhiteSpace(false).allowEmptyLines(true).build();
  ...
  static Stream<Arguments> letterListAndExpectedConsoleOutputProvider() {
    return Stream.of(
        ...
        Arguments.arguments(
            Arrays.asList("A", "B", "C", null, "E"),
            Arrays.asList("  __A", " /   \\", "B     C", " \\", "  E")),
        Arguments.arguments(
            Arrays.asList("A", "B", "C", null, "E", "F"),
            Arrays.asList("  __A__", " /     \\", "B       C", " \\     /", "  E   F")),
        Arguments.arguments(
            Arrays.asList("A", "B", "C", null, "E", "F", "G"),
            Arrays.asList("  __A__", " /     \\", "B       C", " \\     / \\", "  E   F   G")),
        Arguments.arguments(
            Arrays.asList("A", "B", "C", "D", "E", "F", "G"),
            Arrays.asList(
                "    __A__", "   /     \\", "  B       C", " / \\     / \\", "D   E   F   G")));
